...
export const ResponseFormatService = {
   ...
   */
  findById: async (id: number): Promise<ResponseFormat | null> => {
    try {
  ...
  findAll: async (params: {
    ...
    try {
      ...
      // Show global formats and user's own formats
      if (createdBy) {
        query = query.where((builder) => {
  ...
  create: async (formatData: {
    ...
    try {
      ...
      return ResponseFormatService.findById(id) as Promise<ResponseFormat>;
    } catch (error) {
  ...
  update: async (
    ...
    try {
      ...
      return ResponseFormatService.findById(id);
    } catch (error) {
